...
<%@ include file="/inc/taglibs.inc" %>
		...
		<script type="text/javascript">
			$(document).ready(function(e) {
				...
				$(".tablelink").click(function(){
					openWindow('任务进度','view.jsp',['660px','500px']);
				});
			});
			
			// 确认接收
			function confirm(id){
				$("#myform").attr("action","/yw-nm/taskUnit/update.do?pageType=3&status=1&taskId="+id);
				$("#myform").submit();
			}
			
			//处理
			function handle(id){
				openWindow('任务处理','/yw-nm/taskUnit/jump.do?pageType=3&taskId='+id,['800px','500px']);
			}
	...
	<body>
		<div class="rightinfo">
			<form id="myform" method="post" action="/yw-nm/taskUnit/list.do?pageType=3">
				<!--查询-->
				<ul class="seachform">
					...
					<li><label>任务名称</label><input name="taskName" type="text" class="scinput" value="${query.taskName}" >
					</li>
	...
	$(function(){
		//列
   		var cols = [
	        ...
	        { title:'详情',width:80,name:'status',align:'center',renderer:function(val,item,rowIndex){
