...
<body class="bodyGrey">
	<div class="formbody">
		<form id="myform" method="post" action="/yw-nm/taskUnit/update.do?pageType=1">
		<input type="hidden" id="feedBackFilePath" name="feedBackFilePath" />
		<input type="hidden" id="feedBackFileName" name="feedBackFileName" />
		<input type="hidden" id="taskId" name="taskId" value="${task.taskId}" />
			<table class="formview">
				...
				<tr>
					<td valign="top">
						<label>任务详情</label>
						<input type="hidden" id="taskDetail" name="taskDetail" value="${task.taskDetail}" />
					</td>
					<td>
						${task.taskDetail}
					</td>
				...
				<tr>
					...
					<td>
						<textarea name="feedBackDetail" cols="" rows="" class="textinput" style="height: 80px;"></textarea>
					</td>
				</tr>
			</table>
		</form>
			<tr>
				...
				<td>
					...
					<span  id="fileName" >所有文件打包上传</span>
					<!-- <ul style="margin-left:85px;margin-top:10px;margin-right:9px"> </ul> -->
				</td>
